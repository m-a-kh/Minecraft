...
//                            this.drawString(this.fontRendererObj, "Please restart the game if you see this message again.", this.width / 2 - 140, this.height / 4 - 60 + 60 + 81, 10526880);
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        String name123 = "test" + (new Random()).nextLong();
        WorldSettings.GameType worldsettings$gametype = WorldSettings.GameType.SURVIVAL;
        WorldSettings worldsettings = new WorldSettings(i, worldsettings$gametype, true, true, WorldType.worldTypes[0]);
        worldsettings.setWorldName(name123);

        worldsettings.enableBonusChest();
//        worldsettings.enableCommands();


        getMinecraft().launchIntegratedServer(name123, name123.trim(), worldsettings);
//        getMinecraft().launchIntegratedServer("New Worldasdasd", "New Worldasdasdas", null);
...
//            getMinecraft().thePlayer.respawnPlayer();
        }
